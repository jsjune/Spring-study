...
import com.miniProject.EmbeddedRedis;
import com.miniProject.exception.ApplicationException;
...
class UserQueueServiceTest {
	...
	void registerWaitQueue() {
		StepVerifier.create(userQueueService.registerWaitQueue("default", 100L))
			.expectNext(1L)
			.verifyComplete();
		StepVerifier.create(userQueueService.registerWaitQueue("default", 30L))
			.expectNext(2L)
			.verifyComplete();
		StepVerifier.create(userQueueService.registerWaitQueue("default", 48L))
			.expectNext(3L)
			.verifyComplete();
	}
