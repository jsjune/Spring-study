...
import com.sample2.dto.UserPostResponse;
import com.sample2.dto.UserResponse;
import com.sample2.dto.UserUpdateRequest;
...
public class UserController {
	...
	public Mono<ResponseEntity<?>> deleteUserByName(@RequestParam("name") String name) {
